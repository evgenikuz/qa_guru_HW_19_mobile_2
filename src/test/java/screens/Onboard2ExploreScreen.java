...
public class Onboard2ExploreScreen {
    ...
    public Onboard2ExploreScreen checkHeader(String headerText) {
        header.shouldHave(text(headerText));
        return this;
    }

    public Onboard2ExploreScreen checkSkipButtonExists() {
        skipButton.shouldHave(text("Skip"));
        return this;
    }

    public Onboard2ExploreScreen pressContinueButton() {
